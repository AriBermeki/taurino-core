...
use crate::{
    types::{Color, Icon, Theme, WindowSizeConstraints},
    window::{Window, WindowMeta, factory::create_window},
    wrapper::TaoIcon,
};
...
pub struct WindowBuilder {
    ...
    #[cfg(windows)]
    pub(crate) background_color: Option<tao::window::RGBA>,
    #[cfg(windows)]
    pub(crate) is_window_transparent: bool,
    #[cfg(target_os = "macos")]
    pub(crate) tabbing_identifier: Option<String>,
    pub(crate) window_event_listener: WindowEventListener,
}
...
impl WindowBuilder {
    ...
    */
    ...
    pub fn build<T: 'static>(
        ...
        create_window(window_target, self)
    }
}
